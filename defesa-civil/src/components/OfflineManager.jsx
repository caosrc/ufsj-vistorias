...
export default function OfflineManager() {
  ...
  // Detectar online/offline e tamanho da tela
  useEffect(() => {
  ...
  return (
    <>
      ...
      <button
        ...
        style={{
          position: 'fixed', bottom: isMobile ? 82 : 20, right: 20, zIndex: 9998,
      ...
      {open && (
        <div style={{
          position: 'fixed', bottom: isMobile ? 136 : 74, right: 20, zIndex: 9997,
